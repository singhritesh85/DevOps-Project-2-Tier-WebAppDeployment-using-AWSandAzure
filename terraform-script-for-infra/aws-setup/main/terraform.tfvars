...
#  backup_retention_period = 7   ### For Demo purpose I am not creating any db backup.
  kms_key_id = "arn:aws:kms:us-east-2:02XXXXXXXXXXX6:key/2XXXXXXXX3-aXXc-4XXd-9XX4-2XXXXXXXXXXXXX7"
#  read_replica_kms_key_id = "arn:aws:kms:us-east-2:027XXXXXXX06:key/20XXXXXXf3-aXXc-4XXd-9XX4-24XXXXXXXXXX17"  ### I am not using any read replica here.
  monitoring_role_arn = "arn:aws:iam::02XXXXXXXXXXXX6:role/rds-monitoring-role"
...
ip_address_azure_vpn_gtw = "40.88.9.233"                   ### Provide Public IP Address of Azure VPN Gateway
